-- Drop and Recreate Functions - Clean State
-- Drops old functions and recreates with proper search_path security
-- 
...
DROP FUNCTION IF EXISTS public.update_user_preferences(UUID, TEXT, TEXT, BOOLEAN, BOOLEAN, BOOLEAN);
DROP FUNCTION IF EXISTS public.update_user_preferences(UUID, BOOLEAN, BOOLEAN, BOOLEAN);

-- Recreate update_user_profile with proper security
...
-- Recreate update_user_preferences with proper security

 ...
 * 
 * Warehouse package intake system for logging packages into inventory.
 * Allows warehouse staff to scan suite numbers, fetch user details, and register packages.
 * 
